...
namespace wpfHouseholdAccounts
{
    class MoneyInput
    {
        ...
        public static List<MakeupDetailData> GetInputDetailAll(DbConnection myDbCon)
        {
            ...
            SelectCommand = SelectCommand + "      FROM V_INPUTDETAIL \n";
            //SelectCommand = SelectCommand + "      WHERE 明細種別 = 1 AND 年月日 >= '2022-04-01' AND 年月日 <= '2023-03-31' AND NOT (借方 IN ('10214', '20801', '60103', '13002') OR 貸方 IN ('10214', '20801', '10212') OR 貸方 LIKE '34%' OR 貸方 LIKE '31%') \n";
